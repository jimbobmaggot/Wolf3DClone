...
public class Door
{
    ...
    public static final double TIME_TO_OPEN = 0.25; //TODO: Make values appropriate
    ...
    public Door(Transform transform, Material material, Vector3f openPosition)
    {
        ...
        if (mesh == null)
        {
            ...
            Vertex[] vertices = new Vertex[]
            {
                ...
                new Vertex(new Vector3f(LENGTH, HEIGHT, START), new Vector2f(.75f, 0.75f)),
                new Vertex(new Vector3f(LENGTH, START, START), new Vector2f(.75f, 1)),
